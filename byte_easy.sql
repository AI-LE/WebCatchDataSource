...
CREATE TABLE `t_blogger_content`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 153 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `t_blogger_img` VALUES (1, 'https://wx2.sinaimg.cn/orj360/c03332bagy1g333ntpkojj20j62bqgwa.jpg', 'D:/word/201906251149114294.jpg', 4372568481300319);
INSERT INTO `t_blogger_img` VALUES (2, 'https://wx2.sinaimg.cn/orj360/c03332bagy1g333nv5adwj207o09w0t4.jpg', 'D:/word/201906251149253060.jpg', 4372568481300319);
...
CREATE TABLE `t_blogger_old`  (
  ...
  `timeduring` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '时间阶段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 311 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `t_recordssum`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1291 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `zhihu_oldrecords`  (
  ...
  `uuid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件名',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `zhihu_oldrecords` VALUES (2, '2019-06-22 17:38:17', '毛不易唱歌好吗', 'admin', 64, '1561196297785');
